...
const personagens = {
  oliver: {
    ...
    ativo: null, // Define se o perfil está ativo ou inativo (true = ativo, false = inativo, null = desconhecido)
    ...
    relacionamentos: ["Ivy Naranjo", "Tessia Amberine"],
  ...
  ivy: {
    ...
    foto: "ivy.png",
    ativo: false, // Define se o perfil está ativo ou inativo
...
function mostrarPerfil(personagemKey) {
  ...
  profileContent.innerHTML = `
     ...
     style="background-image:url('${personagem.foto || ""}')" 
     onclick="abrirImagemModal('${personagem.foto || ""}', '${
    personagem.nome
  }')"></div>
